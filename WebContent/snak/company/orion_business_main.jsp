			...
			<div id="contentsBody">
				...
				<div id="subContents" class="company">
					...
					<div class="subTitleArea borderNone">
						<h3>
							<img
								src="http://www.orionworld.com/images/company/subtit_orion_business.gif"
								alt="오리온 사업영역" />
						</h3>

						<div class="location">Home &gt; Company &gt; 오리온 사업영역</div>
					</div>

					<!-- 서브 비쥬얼 -->
					<div class="subVisual busiSubvisual">
						<!-- <div class="visual"><script type="text/javascript">showFlash("http://www.orionworld.com/flash/business.swf", "760", "290;", "");</script></div>   -->
						<div class="visual">
							<script type="text/javascript">
							<!--
								var flashvars = {};
								...
								swfobject
										.embedSWF(
												"http://www.orionworld.com/flash/business.swf",
												"intro", "760", "290", "9.0.0",
							...
							<div id="intro">
								<img src="http://www.orionworld.com/images/fimg/flash_biz.jpg"
									usemap="#intro"
									alt="맛있는 별, 재미있는 별, 행복한 별, 세계 속의 별... 온세상에 오리온의 별이 가득 차게 될 때까지 오리온의 즐거운 꿈은 계속됩니다. 즐거움을 감동으로 이어가는 토털 엔터테인먼트 그룹 오리온." />
							</div>
						</div>
					</div>
					<!-- //서브 비쥬얼 -->

					<div class="orionBusiSubmain">

						<div class="entertainment">
							<h4>
								<img
									src="http://www.orionworld.com/images/company/tit_entertainment.gif"
									alt="엔터테인먼트 - 오리온이 만들면 문화가 된다! 최고의 엔터테인먼트 기업 오리온은 미디어, 영화, 공연 등 다양한 분야에서 새로운 장을 열어가고 있습니다." />
							</h4>
							<ul>
								<li style="margin-right: 50px;"><a
									href="http://orions.co.kr/orions/" target="_blank"><img
										src="http://www.orionworld.com/images/company/entertain04.gif"
										alt="오리온즈" /></a></li>
								<li><a href="entertainment03.jsp"><img
										src="http://www.orionworld.com/images/company/entertain02.gif"
										alt="SHOWBOX" /></a></li>
								<!-- <li><a href="http://orions.co.kr/orions/" target="_blank"><img src="http://www.orionworld.com/images/company/entertain03.gif" alt="MEGABOX" /></a></li> -->
							</ul>
						</div>

						<div class="globalBusi">
							<h4>
								<img
									src="http://www.orionworld.com/images/company/tit_global_business.gif"
									alt="글로벌 사업 - 세계에서 인정 받는 대한민국 대표기업 오리온의 저력! 세계 일류 브랜드가 될 때까지 글로벌 비즈니스는 멈추지 않습니다" />
							</h4>
							<ul>
								<li><a href="global_business02.jsp"><img
										src="http://www.orionworld.com/images/company/global01.gif"
										alt="중국(China)" /></a></li>
								<li><a href="global_business03.jsp"><img
										src="http://www.orionworld.com/images/company/global02.gif"
										alt="러시아(Rusia)" /></a></li>
								<li><a href="http://www.orion-japan.com/" target="_blank"
									title="[새창]"><img
										src="http://www.orionworld.com/images/company/global04.gif"
										alt="일본(Japan)" /></a></li>
								<li class="end"><a href="global_business05.jsp"><img
										src="http://www.orionworld.com/images/company/global03.gif"
										alt="베트남(Vietnam)" /></a></li>
							</ul>
						</div>
