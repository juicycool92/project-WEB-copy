			...
			<div id="contentsBody">
									...
									<li class="sub"><span><a
										...
										<ul class="twot">
											...
											<li><a href="brochure.jsp"><img
													src="../../images/common/lmenu_sub_brochure.png" alt="브로슈어" /></a></li>
										</ul></li>
									<li class="sub"><span><a
				...
				<div id="subContents">
					...
					<div class="subTitleArea borderNone">
						<h3>
							<img
								src="http://www.orionworld.com/images/company/subtit_ethical.gif"
								alt="윤리경영" />
						</h3>
...
.tabs_wrap {
	width: 100%;
	border-bottom: solid 2px #e21321;
}
...
.tabs_wrap ul li {
	...
	height: 22px;
					...
					<div class="tabs_wrap">
						<ul>
							<li><a href="ethical01.jsp"><img
									src="http://www.orionworld.com/images/tab/ethical01_tabs_off.gif"
									alt="오리온 인의 약속" title="오리온 人의 약속" /></a></li>
							<li><a href="ethical02.jsp"><img
									src="http://www.orionworld.com/images/tab/ethical02_tabs_on.gif"
									alt="위반행위 신고" title="위반행위 신고" /></a></li>
						</ul>
					</div>


					<div class="subDesc02" style="margin-top: 40px;">
						<p>
							<img
								src="http://www.orionworld.com/images/company/ethical02_tit.gif"
								alt="오리온은 윤리경영 정착을 위해 ‘오리온人의 약속’ 에 위반되는 비윤리적 행위에 대한 익명신고시스템을 운영하고 있습니다." />
						</p>
					</div>
					...
					<div class="ciWrap">
						<p>
							<img
								src="http://www.orionworld.com/images/company/ethical02_txt.gif"
								usemap="#map1" alt="신고 대상 신고 및 상담" />
							<map name="map1">
								<area shape="rect" coords="111,164,232,179"
									href="http://www.kbei.org/orion" target="_blank" title="" />
								<area shape="rect" coords="234,184,389,202"
									href="mailto:orioncsr@orionworld.com" title="" />
							</map>
						</p>
