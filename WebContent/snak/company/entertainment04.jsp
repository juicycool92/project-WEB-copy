	...
	margin-left: 0;
			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTabMenu" id="subTab">
						<!--
                        <img src="/images/company/entertain_tab04_on.gif" usemap="#subTab2" alt="오리온스" />
                       <map id="subTab2" name="subTab2">
							< !--area shape="rect" coords="10,0,90,22" href="entertainment01.asp" alt="엔터테인먼트" /-- >
							<area shape="rect" coords="10,1,79,25" href="entertainment02.asp" alt="스포츠토토" />
							<area shape="rect" coords="79,0,132,24" href="entertainment03.asp" alt="쇼박스" />
							<area shape="rect" coords="136,0,197,23" href="entertainment04.asp" alt="오리온스" />
				  	  </map>
					  -->
						<!-- new_tab_wrap -->
						<div class="new_tab_wrap">
							<ul class="new_tab">
								<!-- <li class="fst"><a href="entertainment02.asp"><img src="/images/tab/tab_toto.png" alt="스포츠토토" /></a></li> -->
								<li class="fst"><a href="entertainment03.jsp"><img
										src="http://www.orionworld.com/images/tab/tab_box.png"
										alt="쇼박스" /></a></li>
								<li><a href="entertainment04.jsp"><img
										src="http://www.orionworld.com/images/tab/tab_orions_on.png"
										style="position: relative; * left: 6px" class="over"
										alt="오리온스" /></a></li>
							</ul>
						</div>
						<!-- // new_tab_wrap -->
					...
					<div class="subDesc02">
						<p>
							<img
								src="http://www.orionworld.com/images/company/subdesc_entertainment05.gif"
								alt="오리온스는 감탄사다! 지역 주민, 그리고 팬과 함께 성장하는 오리온스 농구단" />
						</p>
					</div>
					...
					<div class="entertainmentWrap">
						<div class="entertainmentWrap2 ">
							<div class="nationalFlag">
								<img
									src="http://www.orionworld.com/images/company/img_logo_orions.gif"
									alt="오리온스" />
							</div>

							<div class="entertainmentIntro">
								<p class="enter_padding">
									<img
										src="http://www.orionworld.com/images/company/txt_orions01.gif"
										alt="2011년, 연고지를 고양으로 이전하며 새롭게 출발한 오리온스는 지역 밀착도를 높이고 농구 저변을 확대하는 데 주력했습니다. 또한 지역 유관 기관들과 다양한 관계를 맺고 고양시민들에게 다양한 볼거리와 문화 혜택을 제공했습니다. 스포츠토토와 함께 고양시 장애인 종합 복지관에 재활기구와 선물세트를 기증하는 등 사회 공헌 활동도 활발하게 했습니다. 앞으로도 '정상을 향한 끊임없는 준비와 노력'으로 경기력 향상을 통해 팬들의 기대와 사랑에 부응하고, 팬들과 함께 지속적으로 발전하는 오리온스가 되겠습니다." />
								</p>
							</div>
						</div>

						<p style="text-align: center; width: 100%; padding: 20px 0;">
							<a href="http://www.orions.co.kr/" target="_blank"
								title="오리온스 홈페이지 바로 가기[새창]"><img
								src="http://www.orionworld.com/images/company/btn_orions.gif"
								alt="고양 오리온스 홈페이지 바로 가기" /></a>
						</p>
					</div>
		...
		<div id="footerWrap">
			<div id="footer">
				...
				<!-- footer menu -->
				<ul class="footerMenu">
					<li><a href="../footer/pop_legajsptice.html" target="_blank"
...
<!-- Mirrored from www.orionworld.com/Snak/company/entertainment04.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 May 2017 01:30:33 GMT -->
</html>
