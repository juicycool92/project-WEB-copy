			...
			<div id="contentsBody">
				...
				<div id="subContents" class="company">
					...
					<div class="subTitleArea borderNone">
						<h3>
							<img
								src="http://www.orionworld.com/images/company/subtit_orion_intro.gif"
								alt="오리온 소개" />
						</h3>

						<div class="location">Home &gt; Company &gt; 오리온 소개</div>
					</div>

					<!-- 서브 비쥬얼 -->
					<div class="subVisual introSubvisual">
						<div class="visual">
							<!-- <script type="text/javascript">showFlash("http://www.orionworld.com/flash/company.swf", "760", "464;", "");</script> -->
							<script type="text/javascript">
							<!--
								var flashvars = {};
								var params = {};
								...
								swfobject
										.embedSWF(
												"http://www.orionworld.com/flash/company.swf",
												"intro", "760", "464", "9.0.0",
							...
							<div id="intro">
								<img src="http://www.orionworld.com/images/fimg/flash_intro.jpg"
									usemap="#intro_in"
									alt="즐거움과 행복이 가득한 오리온 그룹! 세계속의 오리온을 만들어가는 힘입니다. CEO메세지 - 오리온 그룹 홈페이지를 방문해 주신 여러분! 항상 깊은 관심으로 오리온을 성원해 주셔서 감사합니다." />
								<map name="intro_in" id="intro_in">
									<area shape="rect" coords="534,360,680,409" href="ceo01.jsp"
										title="담철곤 회장의 메세지 보기" alt="담철곤 회장의 메세지 보기" />
								</map>
							</div>
						</div>
					</div>
					...
					<div class="orionIntroMainBottom">
						...
						<!--div class="orionWaySubmain">	
							<h5><img src="http://www.orionworld.com/images/company/tit_orion_way.gif" alt="오리온 Way" /></h5>
							<p class="relatedImg"><img src="http://www.orionworld.com/images/company/img_orion_way.gif" alt="" /></p>
							<p><img src="http://www.orionworld.com/images/company/txt_orion_way.gif" alt=" Smart, Strong, World-Class. 오리온 가족들의 모든 일과 생각과 행동에 대한 기본 철학입니다." /></p>
							<ul>
								<li><a href="orionjsp.html"><img src="http://www.orionworld.com/images/button/orion_way.gif" alt="오리온 Way" /></a></li>
								<li><a href="orion_way_list.asp.htm"><img src="http://www.orionworld.com/images/button/orion_way_only.gif" alt="오리온 Way (Only Orion" /></a></li>
							</ul>
						</div-->
						<!-- //오리온 Way -->
						...
						<!--div class="introCISubmain">	
							<h5><img src="http://www.orionworld.com/images/company/tit_intro_ci.gif" alt="CI 소개" /></h5>
							<p class="relatedImg"><img src="http://www.orionworld.com/images/company/img_intro_ci.gif" alt="CI" /></p>
							<p><img src="http://www.orionworld.com/images/company/txt_intro_ci.gif" alt=" 지구를 둘러 싸고 있는 일곱개의 점점 커지는 별! 글로벌 그룹 오리온의 세계로 뻗어가는 미래의지의 상징입니다." /></p>
							<ul>
								<li><a href="ci.asp.html"><img src="http://www.orionworld.com/images/button/go.gif" alt="바로가기" /></a></li>
							</ul>
						</div-->
						<!-- //CI 소개 -->
