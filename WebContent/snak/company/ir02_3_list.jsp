...
.gnb_wrap ul.topm li:first-child {
			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTitleArea borderNone">
						<h3>
							<img src="images/company/subtit_stockholder.gif" alt="주주정보" />
						</h3>
					...
					<div class="subTabMenu finance">
						<img src="images/company/stockholder_tab03_on.gif" alt=""
							usemap="#subTab" />
						<map id="subTab" name="subTab">
							<area shape="rect" coords="-1,0,76,25" href="ir02.jsp" alt="주식개요" />
							<area shape="rect" coords="76,0,137,23" href="ir02_2.jsp"
								alt="배당현황" />
							<area shape="rect" coords="137,0,244,27" href="copyingWeb03/BoardList2.bo2"
								alt="Analyst 투자의견" />
						</map>
					</div>
					<!-- //탭 메뉴 -->
					...
					<div class="subDesc03">
						<p>
							<img src="images/company/subdesc_investment.gif"
					...
					<div style="width: 660px;">
						<!-- 검색 -->
						<form name="frmSearch" method="get" action="ir02_3_list.jsp">
						...
						<!-- //검색 -->
						<!-- 게시판 리스트 -->
						<table summary="일자, 내용, 투자의견,목표가, 출처의 Analyst 리스트 게시판 "
							class="boardListType">
							<caption>공시 리스트 게시판</caption>
							<colgroup>
								<col width="12%" />
								<col width="auto" />
								<col width="8%" />
							...
							<thead>
								<tr>
									<th scope="col"><img src="images/board/txt_day.gif"
										alt="일자" /></th>
									<th scope="col"><img
										src="images/board/txt_contents.gif" alt="내용" /></th>
									<th scope="col"><img
										src="images/board/txt_invest.gif" alt="투자의견" /></th>
									<th scope="col"><img
										src="images/board/txt_target.gif" alt="목표가" width="34"
										height="11" /></th>
									<th scope="col" class="end"><img
										src="images/board/txt_origin.gif" alt="출처" /></th>
								</tr>
							</thead>
							<tbody>
								<%
								...
								<tr align="center" valign="middle" bordercolor="#333333"
									...
									<td style="font-family: tahoma; font-size: 10pt">
										<div align="left">
											...
											%>
											<a href="./BoardDetailAction.bo2?num=<%=bl.getBOARD_NUM()%>">
												<%=bl.getBOARD_CONTENT()%></a>
										</div>
									</td>
									<td style="font-family: Tahoma; font-size: 10pt">
										<div align="center"><%=bl.getBOARD_OPINION()%></div>
									</td>

									<td style="font-family: Tahoma; font-size: 10pt">
										<div align="center"><%=bl.getBOARD_GOAL()%></div>
									</td>
									<td style="font-family: Tahoma; font-size: 10pt">
										<div align="center"><%=bl.getBOARD_SOURCES()%></div>
									</td>
								</tr>
								<%
									}
 ...
 %> <a href="./BoardList.bo2?page=<%=nowpage + 1%>">[다음]</a> <%
 	}
 %>
									</td>
								</tr>
