...
.gnb_wrap ul.topm li:first-child {
	margin-left: 0;
			...
			<div id="contentsBody">
				...
				<!-- Sub Contents -->
				<div id="subContents" class="company">

					<div class="subTitleArea borderNone">
						<h3>
							<img
								src="http://www.orionworld.com/images/company/subtit_orion_history_view.gif"
								alt="오리온 역사관" />
						</h3>

						<div class="location">Home &gt; Company &gt; 오리온 역사관</div>
					</div>

					<!-- 서브 비쥬얼 -->
					<div class="subVisual introSubvisual">
						<!-- <div class="visual"><script type="text/javascript">showFlash("http://www.orionworld.com/flash/history.swf", "760", "454;", "");</script></div>	 -->
						<div class="visual">
							<script type="text/javascript">
							<!--
								var flashvars = {};
								...
								swfobject
										.embedSWF(
												"http://www.orionworld.com/flash/history.swf",
												"intro", "760", "454", "9.0.0",
												false, flashvars, params1,
												attributes);
							//-->
							</script>
							<div id="intro">
								<img
									src="http://www.orionworld.com/images/fimg/flash_history.jpg"
									usemap="#intro"
									alt="제과 산업부터 엔터테인먼트 산업에 이르기까지 오리온 그룹이 걸어온 발자취 더욱 빛나는 새로운 50년을 향해 또 한번 힘차게 도약합니다." />
								<map name="intro" id="intro">
									<area shape="rect" coords="586,322,759,368" href="founder.jsp"
										title="창업구 이양구 회장 만나러 가기" alt="창업구 이양구 회장 만나러 가기" />
								</map>
							</div>
						</div>
					</div>
					...
					<div class="orionIntroMainBottom">

						<!-- 2010-07-09 -->
						<!--div class="orionWaySubmain">	
							<h5><img src="http://www.orionworld.com/images/company/tit_history.gif" alt="연혁" /></h5>
							<p class="relatedImg"><img src="http://www.orionworld.com/images/company/img_history.gif" alt="" /></p>
							<p><img src="http://www.orionworld.com/images/company/txt_history.gif" alt="history 오리온의 역사는 우리나라 제과 산업의 역사 입니다. 오리온의 성장은 우리나라 엔터테인먼트 산업의 성장 입니다." /></p>
							<ul>
								<li><a href="history00.asp.html"><img src="http://www.orionworld.com/images/button/50years.gif" alt="50년" /></a></li>
								<li><a href="history_year01_1.asp.html"><img src="http://www.orionworld.com/images/button/years.gif" alt="년도별" /></a></li>
							</ul>
						</div-->
						<!-- //연혁 -->

						<!-- 제과 ’50 -->
						<!--div class="introCISubmain">	
							<h5><img src="http://www.orionworld.com/images/company/tit_snack50.gif" alt="제과 ’50" /></h5>
							<p class="relatedImg"><img src="http://www.orionworld.com/images/company/img_snack50.gif" alt="" /></p>
							<p><img src="http://www.orionworld.com/images/company/txt_snack50.gif" alt="50년 전 이땅에 제과 업계의 큰 별로 탄생한 오리온.  더욱 빛나는 새로운 50년을 향해 또 한번 힘차게 도약 합니다." /></p>
							<ul>
								<li><a href="snack50_01.asp.html"><img src="http://www.orionworld.com/images/button/history.gif" alt="역사" /></a></li>
								<li><a href="library.asp.html"><img src="http://www.orionworld.com/images/button/library.gif" alt="라이브러리" /></a></li>
							</ul>
						</div-->
						<!-- //제과 ’50 -->
