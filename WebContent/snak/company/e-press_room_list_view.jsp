			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTitleArea">
						<h3><img src="images/company/subtit_epress_room.gif" alt="e-프레스룸"></h3>
						
						<div class="location">
							Home &gt; Company  &gt; PR 정보 &gt; e-프레스룸 	
						</div>
					</div>

					<div class="subDesc02">
						<p><img src="images/company/subdesc_epress_room.gif" alt="고객의 관심과 사랑으로 성장해 온 오리온 새롭게 변화하는 오리온의 눈부신 행보를 지켜봐 주십시오."></p>	
					</div>

					<!-- 게시판 상세보기 -->
					<table summary="e-프레스룸 보기 게시판" class="boardViewType">
						<caption>e-프레스룸 보기 게시판</caption>
						<colgroup>
							<col width="auto">
							<col width="6%">
							<col width="20%">
						...
						<tbody>
							<tr class="first">
								<th class="title" scope="row"><%=vo.getTitle() %></th>
								<th scope="row"><img src="images/board/txt_date_view.gif" alt="작성일"></th>
								<td><%=vo.getUploaddate() %></td>
								<th scope="row"><img src="images/board/txt_hit_view.gif" alt="조회수"></th>
								<td><%=vo.getCount() %></td>
							</tr>
							<tr>
								<td class="viewContents p_padding" colspan="5">
									<p>&nbsp;</p>
									<p>
									<%=vo.getContext() %>
									</p>
					...
					<div class="bottomBtns">
						<div class="btnCenter">
							<a href="pressViewUser.epress?curPage=1"><img src="images/button/list.gif" alt="LIST"></a>
						</div>
					</div>
