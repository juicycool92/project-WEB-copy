			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTabMenu" id="subTab">
						<!--
                        <img src="http://www.orionworld.com/images/company/global_busi_tab05_on.gif" usemap="#subTab2" alt="" />
						<map id="subTab2" name="subTab2">
						  <area shape="rect" coords="0,-1,54,23" href="global_business02.asp.html" alt="중국" />
						...
						<div class="new_tab_wrap">
							<ul class="new_tab">
								...
								<li><a href="global_business05.jsp"><img
										src="http://www.orionworld.com/images/tab/tab_vietnam_on.png"
										style="position: relative; *left: -3px" class="over" alt="베트남" /></a></li>
					...
					<div class="subDesc02">
						<p>
							<img
								src="http://www.orionworld.com/images/company/subdesc_global_busi05.gif"
								alt="베트남의 국민과자로 우뚝 선 오리온, 이제 아세안과 인도시장으로 눈을 돌립니다." />
						</p>
					</div>
					<p style="margin-top: 20px">
						<img src="http://www.orionworld.com/images/company/2015bt.gif" />
					</p>


					<!-- 					<p style="margin-top:20px"><img src="http://www.orionworld.com/images/company/txt_vietnam_info021.png" alt="오리온 초코파이는 베트남 파이시장 점유율 60%를 기록할 만큼 대인기를 독점하고 있으며 베트남 사람들의 제사상에도 올라갈 정도로 '단순한 과자' 이상의 많은 사랑을 받고 있습니다. 2006년 9백만 달러 수준이던 매출액을 2007년 100% 신장시켰고, 오리온 초코파이를 중심으로 하는 강력한 파이군 제품과, 투니스, 오스타를 내세운 스낵제품으로 2010년에는 내수 매출만 7천만 달러 이상을 기록하며 강력한 경쟁자들 상대로 계속 시장을 확대해가고 있습니다." /></p>
					<p><img src="http://www.orionworld.com/images/company/txt_vietnam_info022.png" alt="오리온은 베트남을 교두보로 삼아 향후에는 말레이시아, 싱가포르, 태국 등 아세안 국가 및 인도시장 등으로 시장을 지속적으로 확대해 나갈 계획입니다." /></p> -->
				</div>
				<!-- //Sub Contents -->
