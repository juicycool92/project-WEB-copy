...
<script type="text/JavaScript">
	...
	function zipBoard(assort) {
		var aspName = "../../Myor/Member/zipBoardb1a0.html?ChangTmp=1&amp;strFrmName=frmMember_"
				+ assort;
		objZipWin = window
				.open(
						aspName,
...
.gnb_wrap ul.topm li:first-child {
	margin-left: 0;
					...
					<div class="gnb_wrap" id="gnbnew">
						<ul class="topm">
							<li class="onem"><a
								href="../power_brand/productinfo8b29.html?icodeNo=117"
								...
								<div class="twom"
									...
									<ul class="tm">
										<li><a
											href="../power_brand/productinfo8b29.html?icodeNo=117"><img
							...
							<li class="onem"><a
								href="../power_brand/productinfo78e0.html?icodeNo=6" class="oda"><img
								...
								<div class="twom"
									...
									<ul class="tm">
										<li><a
											href="../power_brand/productinfo78e0.html?icodeNo=6"><img
												src="images/common/g2_product.png" class="_on"
												title="ORION POWER BRAND" alt="Product Info" /></a></li>
										<li><a
											href="../power_brand/view_cfba4b.html?iCodeNo=1&amp;iAssortNo=4"><img
							...
							<li class="onem"><a href="voc.html" class="oda"><img
									src="images/common/g1_customer.png" class="od"
									title="CUSTOMER" alt="CUSTOMER" /></a> <!-- twom -->
								<div class="twom">
									<ul class="tm">
										<li><a href="voc.html"><img
		...
		<area shape="rect" coords="688,2,787,32" href="" alt="Company" />
			...
			<div id="contentsBody">
				...
				<form name="frmMemberWrite" method="post"
					action="BoardModifyAction.bo?NUM=<%=board.getNUM()%>"
					...
					<div id="subContents">
						...
						<div class="subTabMenu" id="subTab">
							<div class="new_tab_wrap">
								<ul class="new_tab">
									<li class="fst"><a
										href="./snak/you_n_orion/event150304.jsp"><img
											src="images/tab/tab_idea_on.png" class="over"
											alt="의견 접수" /></a></li>
									<li><a href="./snak/you_n_orion/find_my_inquiry02.jsp"><img
						...
						<div class="subDesc02">
							<img src="images/you_n_orion/event_img_01.gif"
						...
						<div class="agreementWrap">
							...
							<div class="inputOpinon">
										...
										<tbody>
											<tr>
												...
												<td><input type="text" size="18" name="NAME"
													value="<%=board.getNAME()%>" class="textType" id="fname"
													title="이름 입력" /></td>
											</tr>
											<tr>
												...
												<td><input type="text" size="18" name="EMAIL_1"
													value="<%=board.getEMAIL_1()%>" id="femail" value=""
													class="textType" title="이메일 계정입력" /> <input type="text"
													size="18" name="EMAIL_2" value="<%=board.getEMAIL_2()%>"
													class="textType" title="이메일 주소입력" /> <select
													onchange="javascript:email_change();" name="email_list"
													title="이메일계정 선택">
														<option value="">직접입력</option>
														<option value="naver.com"
															<%=(board.getEMAIL_2().equals("naver.com")) ? "selected" : ""%>>
															naver.com</option>

														<option value="chol.com"
															<%=(board.getEMAIL_2().equals("chol.com")) ? "selected" : ""%>>
															chol.com</option>

														<option value="dreamwiz.com"
															<%=(board.getEMAIL_2().equals("dreamwiz.com")) ? "selected" : ""%>>dreamwiz.com</option>
														<option value="empal.com"
															<%=(board.getEMAIL_2().equals("empal.com")) ? "selected" : ""%>>empal.com</option>
														<option value="freechal.com"
															<%=(board.getEMAIL_2().equals("freechal.com")) ? "selected" : ""%>>freechal.com</option>
														<option value="gmail.com"
															<%=(board.getEMAIL_2().equals("gmail.com")) ? "selected" : ""%>>gmail.com</option>
														<option value="hanafos.com"
															<%=(board.getEMAIL_2().equals("hanafos.com")) ? "selected" : ""%>>hanafos.com</option>
														<option value="hanmail.net"
															<%=(board.getEMAIL_2().equals("hanmail.net")) ? "selected" : ""%>>hanmail.net</option>
														<option value="hanmir.com"
															<%=(board.getEMAIL_2().equals("hanmir.com")) ? "selected" : ""%>>hanmir.com</option>
														<option value="hitel.net"
															<%=(board.getEMAIL_2().equals("hitel.net")) ? "selected" : ""%>>hitel.net</option>
														<option value="hotmail.com"
															<%=(board.getEMAIL_2().equals("hotmail.com")) ? "selected" : ""%>>hotmail.com</option>
														<option value="korea.com"
															<%=(board.getEMAIL_2().equals("korea.com")) ? "selected" : ""%>>korea.com</option>
														<option value="lycos.co.kr"
															<%=(board.getEMAIL_2().equals("lycos.co.kr")) ? "selected" : ""%>>lycos.co.kr</option>
														<option value="nate.com"
															<%=(board.getEMAIL_2().equals("nate.com")) ? "selected" : ""%>>nate.com</option>
														<option value="netian.com"
															<%=(board.getEMAIL_2().equals("netian.com")) ? "selected" : ""%>>netian.com</option>
														<option value="paran.com"
															<%=(board.getEMAIL_2().equals("paran.com")) ? "selected" : ""%>>paran.com</option>
														<option value="yahoo.com"
															<%=(board.getEMAIL_2().equals("yahoo.com")) ? "selected" : ""%>>yahoo.com</option>
														<option value="yahoo.co.kr"
															<%=(board.getEMAIL_2().equals("yahoo.co.kr")) ? "selected" : ""%>>yahoo.co.kr</option>
											...
											<tr>
												...
												<td><select name="CALL_1" id="contact"
													title="연락처 앞번호 입력">
														<option value="010"
															<%=(board.getCALL_1().equals("010")) ? "selected" : ""%>>010</option>
														<option value="011"
															<%=(board.getCALL_1().equals("011")) ? "selected" : ""%>>011</option>
														<option value="016"
															<%=(board.getCALL_1().equals("016")) ? "selected" : ""%>>016</option>
														<option value="017"
															<%=(board.getCALL_1().equals("017")) ? "selected" : ""%>>017</option>
														<option value="018"
															<%=(board.getCALL_1().equals("018")) ? "selected" : ""%>>018</option>
														<option value="019"
															<%=(board.getCALL_1().equals("019")) ? "selected" : ""%>>019</option>
												</select> - <input type="text" name="CALL_2"
													value="<%=board.getCALL_2()%>" size="6" class="textType"
													maxlength="4" title="가운데 번호 입력" onkeypress="onlyNumber()" />
													- <input type="text" name="CALL_3"
													value="<%=board.getCALL_3()%>" size="6" class="textType"
											...
											<tr>
												...
												<td><input type="text" size="65" class="textType"
													id="tit" title="제목 입력" value="<%=board.getTITLE()%>"
													name="TITLE" /></td>
											</tr>
											<tr>
												<th scope="row"><label for="etc"><img
														src="images/board/txt_title_other.gif" alt="* 유형" /></label></th>
												<td><input type="radio" name="ETC" id="etc1" value="75"
													<%=(board.getETC().equals("75")) ? "checked" : ""%> /><label
													for="etc1" style="padding: 0 15px 0 5px;">제품</label> <input
													type="radio" name="ETC" id="etc3" value="113"
													<%=(board.getETC().equals("113")) ? "checked" : ""%> /><label
													for="etc3" style="padding: 0 15px 0 5px;">아이디어</label> <input
													type="radio" name="ETC" id="etc2" value="111"
													<%=(board.getETC().equals("111")) ? "checked" : ""%> /><label
													for="etc2" style="padding: 0 15px 0 5px;">이벤트 문의</label> <input
													type="radio" name="ETC" id="etc4" value="115"
													<%=(board.getETC().equals("115")) ? "checked" : ""%> /><label
											...
											<tr>
												...
												<td><textarea cols="65" name="CONTENT" id="cont"
														rows="17" title="내용 입력"><%=board.getCONTENT()%></textarea>
											...
											<tr>
												...
												<td>
													...
													<p style="height: 20px;">
														<span><input type="file" name="I_FILE" id="aflie1"
															class="input" size="20"
															style="border: 1px solid #e0e0e0; font-size: 12px; background-color: #f8f8f8;" /></span>

														<span>
															<!--VALUE="파일명" --> <input type="hidden" name="I_FILE"
															value="<%=board.getFILENAME()%>" /> <label><input
																type="checkbox" name="DEL" value="DELETE" />삭제하기</label> <!-- 체크박스에 체크가 되면 I_FILE에 널값을 주자 -->
															<!-- check되면 value==1이 되겟지 -->
														</span> <span style="margin-left: 10px; color: #000;"><%=board.getFILENAME()%></span>
											...
											<tr class="end">
												...
												<td>
													...
													value="<%=board.getPWD()%>" class="textType"
													maxlength="20" title="비밀번호 입력" />
												</td>
											</tr>
										</tbody>
									</table>
								...
								<p style="margin-top: 10px;">
									<img src="images/you_n_orion/txt_opinon_info3.png"
							...
							<div class="bottomBtns">
								<div class="btnCenter">
									<input type="image" src="images/button/modify2.gif"
										alt="수정" /> <a
