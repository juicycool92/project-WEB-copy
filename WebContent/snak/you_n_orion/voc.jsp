...
<title>You &amp; Orion - 고객 소리VOC</title>
			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTitleArea mb00">
						<h3>
							<img src="../../images/you_n_orion/subtit01.png" alt="고객소리 VOC" />
						</h3>

						<div class="location">Home &gt; Customer &gt; 고객 소리 (VOC)</div>
					</div>
					<!-- voc_wrap -->
					<div class="voc_wrap">
						<p>
							<img src="../../images/you_n_orion/voc_img_n1.png"
								alt="VOC(Voice Of Consumer)란? 전화 및 홈페이지를 통해 들어온 소비자 Claim은 VOC보고서 작성을 통해 매주마다 관련부서에 전달됩니다." />
						</p>
						<p>
							<img src="../../images/you_n_orion/voc_img_n2.png"
								alt="따로 시간을 내어 전화 및 홈페이지를 통해 올려주신 소비자님의 의견, 감사한 마음을 갖고 진심으로 받아들이겠습니다. 상담실을 통해 들어온 소비자 claim은 관련부서에 전달하여 적극적으로 반영되고 있습니다. 소비자님의 의견을 통해 올바른 방향으로 나아가고 있는지 다시 한번 돌아볼수 있는 기회로 삼겠습니다." />
						</p>
						<p>
							<img src="../../images/you_n_orion/voc_img_n3.png"
								alt="VOC / 1.생산(공장&amp;연구소) 2.홍보 3.영업 4.마케팅" />
						</p>
						<p>
							<img src="../../images/you_n_orion/voc_img_t1.png"
								alt="상담 내용 처리과정" />
						</p>
						<p>
							<img src="../../images/you_n_orion/voc_img_t2.png"
								alt="step1. 전화 및 홈페이지 소비자의견 접수 step2.실시간CCMS 프로그램에 입력/응답처리 step3.제품 생산 공장에서 실시간으로 확인 step4.관련부서 통보 개선책 연구 step5.생산공정 체크 및 개선" />
						</p>
						<ul>
							<li style="display: block"><img
								src="../../images/you_n_orion/voc_img_t3.png"
								alt="1. 소비자의 전화를 받는 즉시 실시간으로 ccms프로그램에 상담내용이 등록됩니다." /></li>
							<li style="display: block"><img
								src="../../images/you_n_orion/voc_img_t4.png"
								alt="2. 제품을 생산하는 각 공장에서 ccms프로그램을 통해 접수된 상담을 확인합니다." /></li>
							<li style="display: block"><img
								src="../../images/you_n_orion/voc_img_t5.png"
								alt="3. 유통기한과 제조시간, 생산담당자 조회를 통해 제품에 대한 문제를 개선하기 위한 방안을 찾습니다.(생산공정 system 체크 및 대안책 마련 및 예방활동" /></li>
							<li style="display: block"><img
								src="../../images/you_n_orion/voc_img_t6.png"
								alt="4. 상당실이 속해 있는 품질경영부서에서는 claim내용을 기반으로 생산공정을 점검하고 claim예방 활동을 합니다." /></li>
						</ul>
					</div>
					<!-- // voc_wrap -->
				</div>
...
<!-- Mirrored from www.orionworld.com/Snak/you_n_orion/voc.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 May 2017 00:38:26 GMT -->
</html>
