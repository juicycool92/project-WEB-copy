...
<title>You &amp; Orion - 불만접수 Claim</title>
	...
	function tryFindMyInquiry() {
		...
		$.post("find_my_inquiry_exec.jsp", {
			...
			if (data == 0) {
				...
				$("#form_inquiry").attr("action", "ComplInquiryAction.co"); // 불만 inquiryAction
				$("#form_inquiry").submit();
			}
		});
	}
			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTitleArea borderNone">
						...
						<div class="location">Home &gt; Customer &gt; 불만 접수 (Claim)
						</div>
					</div>
						...
						<div class="new_tab_wrap">
							<ul class="new_tab">
								<li class="fst"><a href="./customer.jsp"><img
										src="../../images/tab/tab_inquiry.png" alt="문의 접수" /></a></li>
								...
								<table summary="접수 내역 조회" class="boardInputType bgDot">
									...
									<tbody>
										...
										<tr>
											...
											<td><select name="strTel" id="CALL_1" title="연락처앞번호선택">
...
<!-- Mirrored from www.orionworld.com/Snak/you_n_orion/find_my_inquiry.asp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 May 2017 00:48:15 GMT -->
</html>
