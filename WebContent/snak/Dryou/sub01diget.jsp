			...
			<div id="contentsBody">
				...
				<div id="subContents">
					...
					<div class="subTitleArea">
						<h3>
							<img src="../../images/dr_you/sub01.png" alt="Dr. You Diget" />
						...
						<div class="location">Home &gt; Dr.You &gt; Dr. You Diget</div>
					</div>

					<div class="subDesc02">
						<img src="../../images/dr_you/sub01_title.png"
							alt="통밀로 설계한 튼튼함 닥터유 다이제" />
					</div>

					<div class="newPoductContents02">
						<img src="../../images/dr_you/sub01_cont1.png"
							alt="1982년에 출시하여 30여년간 변하지 않는 든든함으로 사랑 받아온 통밀과자 닥터유 다이제. 통밀로 설계하여 특유의 거칠고 구수한 맛과 든든함이 특징인 닥터유 다이제는 허전하거나 든든한 간식이 필요할 때, 구수한 통밀의 맛을 느끼고 싶을 땐 다이제 오리지널 초콜릿의 달콤함이 필요할때는 다이제 초코 비스킷과 부드러운 바닐라크림이 잘 조화된 다이제 샌드까지 기호에 맞는 다양한 든든함을 채울 수 있습니다." />
						<img src="../../images/dr_you/sub01_cont2.png"
							alt="구수한 통밀맛 다이제 오리지널, 달콤한 초콜릿 다이제 초코비스킷, 부드러운 바닐라크림 다이제 샌드" />
						<img src="../../images/dr_you/sub01_cont3.png"
							alt="통밀이란? 밀의 껍질과 씨눈을 제거하고 도정한 일반 밀가루와 달리 식이섬유가 가득한 껍질, 비타민과 무기질이 풍부하여 항산화 기능이 탁월한 씨눈까지 함께 갈아 만든 통밀가루" />
					</div>
