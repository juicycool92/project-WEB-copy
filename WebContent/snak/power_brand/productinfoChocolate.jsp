...
<!-- das page ist ah, was ist das? chocolate -->
				...
				<div id="subSide">
					<div id="snb_wrap"
						...
						<div class="snb_in">
							<div class="nav_wrap">
								<ul class="nav">
									<li class="sub"><span><a href="productinfo78e0.jsp"><img
										...
										<ul class="twot">
											...
											<li><a
												href="userSnakView.snak?curPage=1&category=2"><img
													src="images/common/lmenu_sub_02.png" alt="스낵류" /></a></li>
											<li><a
												href="userSnakView.snak?curPage=1&category=3"><img
													src="images/common/lmenu_sub_03.png" alt="비스킷류" /></a></li>
											<li><a
												href="userSnakView.snak?curPage=1&category=4"><img
													src="images/common/lmenu_sub_04.png" alt="껌류" /></a></li>
											<li><a
												href="userSnakView.snak?curPage=1&category=5"><img
													src="images/common/lmenu_sub_05.png" alt="캔디류" /></a></li>
											<li><a
												href="userSnakView.snak?curPage=1&category=6"><img
													src="images/common/lmenu_sub_06.png" alt="초콜렛류" /></a></li>
										</ul></li>
									<li class="sub"><span><a href="snak/power_brand/view_cfba4b.jsp"><img
 ...
 -->
				...
				<div id="subContents">
					...
					<div class="subTitleArea">
						<h3>
							<img src="images/power_brand/subtit_chocolate_type.gif" alt="초컬릿류" />
							<a style="margin-left: 10px;" href="http://blog.orionworld.com/"
								target="_blank"><img src="images/icon/btnBlog.png" alt="블로그" /></a>
					...
					<div class="typeList">
						...
						<div class="typeListLine">
							<dl class="typeListSet">
								<dt>
									<a href="userSnakDetail.snak?num=<%=vo.getNum()%>&category=<%=categori%>"> <img
										src="<%=vo.getTh_image()%>" width="125" height="127"
										alt="<%=vo.getName()%>" />
									</a>
								</dt>
								...
								<dd class="prodIntro">
									<a href="userSnakDetail.snak?num=<%=vo.getNum()%>&category=<%=categori%>"> <img
										src="images/button/product_intro.gif" alt="제품소개" />
									</a>
								</dd>
							</dl>
							<%
						...
						<div align="center">
							...
							%>
							<a
								href="./userSnakView.snak?category=<%=categori%>&curPage=<%=i%>">[<%=i%>]
							</a>
							<%
								} else {
							%>
...
<!-- Mirrored from www.orionworld.com/Snak/power_brand/productinfo.asp?icodeNo=2 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 May 2017 00:43:30 GMT -->
</html>
