...
.gnb_wrap ul.topm li:first-child {
	margin-left: 0;
			...
			<div id="contentsBody">
				...
				<div id="subSide">
					<div id="snb_wrap"
						style="background: url('images/common/left_topNewp_bg.png') no-repeat top;">
						<div class="snb_in">
							<div class="nav_wrap">
								<ul class="nav">
									<li class="sub"><span><a href="productinfo8b29.jsp"><img
												src="images/common/lmenuNew_01.png" alt="new product" /></a></span>
										<ul class="twot">
											<li><a href="productinfo8b29.jsp"><img
													src="images/common/lmenu_subNew_01.png"
													alt="new product" /></a></li>
										</ul></li>
								</ul>
							</div>
						</div>
				...
				<div id="subContents">
					...
					<div class="subTitleArea">
						<h3>
							<img src="images/power_brand/subtit_newP.png"
								alt="신상품" /> <a style="margin-left: 10px;"
								href="http://blog.orionworld.com/" target="_blank"><img
					...
					<div class="typeList">
						...
						<div class="typeListLine">
							<dl class="typeListSet">
								<dt>
									<a href="userSnakDetailNew.snak?num=<%=vo.getNum()%>">
						...
						<div align="center">
							<%
								...
								for(int i = 1 ; i < result+1 ; i ++){
									if(curPage!=i){
										%>
										<a href="./userSnakViewNew.snak?curPage=<%=i%>">[<%=i %>]</a>
										<%
									}else{
										%>
										[<%=i %>] 
...
<!-- Mirrored from www.orionworld.com/Snak/power_brand/productinfo.asp?icodeNo=117 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 May 2017 00:32:25 GMT -->
</html>
